...
const DEFAULTS = {
  ...
  saas_from_email: 'cyber.sec.pro.email.send@gmail.com',
  saas_smtp_pool: [],
...
function serializeValue(value) {
  if (typeof value === 'string') {
    // TOML: stringleri guvenli quote et (cift tirnak icinde ters-slashe kacar)
  ...
  if (typeof value === 'object') {
    // Plain nested object => TOML inline table  { key = val, ... }
  ...
  // Fallback: herhangi bir primitive
  return String(value);
}
